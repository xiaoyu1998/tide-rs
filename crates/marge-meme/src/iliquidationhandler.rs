...
interface ILiquidationHandler {
    function executeLiquidation(address liquidator, LiquidationUtils.LiquidationParams memory params) external;
}
```
...
```*/
    ...
    ///Container for all the [`ILiquidationHandler`](self) function calls.
    pub enum ILiquidationHandlerCalls {
        executeLiquidation(executeLiquidationCall),
    }
    #[automatically_derived]
    impl ILiquidationHandlerCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[131u8, 243u8, 210u8, 235u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ILiquidationHandlerCalls {
        const NAME: &'static str = "ILiquidationHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ILiquidationHandlerCalls>] = &[
                {
                    fn executeLiquidation(
                        ...
                        <executeLiquidationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ILiquidationHandlerCalls::executeLiquidation)
                    }
                    executeLiquidation
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ILiquidationHandler`](self) contract instance.

See the [wrapper's documentation](`ILiquidationHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ILiquidationHandlerInstance<T, P, N> {
        ILiquidationHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ILiquidationHandlerInstance<T, P, N>>,
    > {
        ILiquidationHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ILiquidationHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ILiquidationHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ILiquidationHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ILiquidationHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ILiquidationHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ILiquidationHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ILiquidationHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ILiquidationHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ILiquidationHandlerInstance<T, P, N> {
            ILiquidationHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
