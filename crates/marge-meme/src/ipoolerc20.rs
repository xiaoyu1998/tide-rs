...
```*/
    ...
    ///Container for all the [`IPoolERC20`](self) function calls.
    pub enum IPoolERC20Calls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPoolERC20Calls {
        const NAME: &'static str = "IPoolERC20Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IPoolERC20Calls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPoolERC20Calls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPoolERC20Calls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn PERMIT_TYPEHASH(
                        ...
                        <PERMIT_TYPEHASHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPoolERC20Calls::PERMIT_TYPEHASH)
                    }
                    PERMIT_TYPEHASH
                },
                {
                ...
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPoolERC20Calls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
    ...
    ///Container for all the [`IPoolERC20`](self) events.
    pub enum IPoolERC20Events {
        Approval(Approval),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl IPoolERC20Events {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IPoolERC20Events {
        const NAME: &'static str = "IPoolERC20Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IPoolERC20Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IPoolERC20`](self) contract instance.

See the [wrapper's documentation](`IPoolERC20Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IPoolERC20Instance<T, P, N> {
        IPoolERC20Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IPoolERC20Instance<T, P, N>>,
    > {
        IPoolERC20Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IPoolERC20Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IPoolERC20`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IPoolERC20`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IPoolERC20Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IPoolERC20Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IPoolERC20Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IPoolERC20Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IPoolERC20Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPoolERC20Instance<T, P, N> {
            IPoolERC20Instance {
