...
interface ILiquidityHandler {
    function executeAdd(address account, LiquidityUtils.AddParams memory params) external;
    function executeRemove(address account, LiquidityUtils.RemoveParams memory params) external;
}
```
...
```*/
    ...
    ///Container for all the [`ILiquidityHandler`](self) function calls.
    pub enum ILiquidityHandlerCalls {
        executeAdd(executeAddCall),
        executeRemove(executeRemoveCall),
    }
    #[automatically_derived]
    impl ILiquidityHandlerCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ILiquidityHandlerCalls {
        const NAME: &'static str = "ILiquidityHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ILiquidityHandlerCalls>] = &[
                {
                    fn executeAdd(
                        data: &[u8],
                        validate: bool,
                        ...
                        <executeAddCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ILiquidityHandlerCalls::executeAdd)
                    }
                    executeAdd
                },
                {
                    fn executeRemove(
                        ...
                        <executeRemoveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ILiquidityHandlerCalls::executeRemove)
                    }
                    executeRemove
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ILiquidityHandler`](self) contract instance.

See the [wrapper's documentation](`ILiquidityHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ILiquidityHandlerInstance<T, P, N> {
        ILiquidityHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ILiquidityHandlerInstance<T, P, N>>,
    > {
        ILiquidityHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ILiquidityHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ILiquidityHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ILiquidityHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ILiquidityHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ILiquidityHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ILiquidityHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ILiquidityHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ILiquidityHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ILiquidityHandlerInstance<T, P, N> {
            ILiquidityHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
    ...
    > ILiquidityHandlerInstance<T, P, N> {
        ...
        pub fn executeAdd(
            ...
            self.call_builder(&executeAddCall { account, params })
        }
