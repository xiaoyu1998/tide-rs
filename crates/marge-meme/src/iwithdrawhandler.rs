...
interface IWithdrawHandler {
    function executeWithdraw(address account, WithdrawUtils.WithdrawParams memory params) external;
}
```
...
```*/
    ...
    ///Container for all the [`IWithdrawHandler`](self) function calls.
    pub enum IWithdrawHandlerCalls {
        executeWithdraw(executeWithdrawCall),
    }
    #[automatically_derived]
    impl IWithdrawHandlerCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[38u8, 123u8, 173u8, 234u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IWithdrawHandlerCalls {
        const NAME: &'static str = "IWithdrawHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IWithdrawHandlerCalls>] = &[
                {
                    fn executeWithdraw(
                        data: &[u8],
                        validate: bool,
                        ...
                        <executeWithdrawCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IWithdrawHandlerCalls::executeWithdraw)
                    }
                    executeWithdraw
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IWithdrawHandler`](self) contract instance.

See the [wrapper's documentation](`IWithdrawHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IWithdrawHandlerInstance<T, P, N> {
        IWithdrawHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IWithdrawHandlerInstance<T, P, N>>,
    > {
        IWithdrawHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IWithdrawHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IWithdrawHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IWithdrawHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IWithdrawHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IWithdrawHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IWithdrawHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IWithdrawHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IWithdrawHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IWithdrawHandlerInstance<T, P, N> {
            IWithdrawHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
