...
interface IDepositHandler {
    function executeDeposit(address account, DepositUtils.DepositParams memory params) external;
}
```
...
```*/
    ...
    ///Container for all the [`IDepositHandler`](self) function calls.
    pub enum IDepositHandlerCalls {
        executeDeposit(executeDepositCall),
    }
    #[automatically_derived]
    impl IDepositHandlerCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[15u8, 78u8, 91u8, 161u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IDepositHandlerCalls {
        const NAME: &'static str = "IDepositHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IDepositHandlerCalls>] = &[
                {
                    fn executeDeposit(
                        data: &[u8],
                        validate: bool,
                        ...
                        <executeDepositCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IDepositHandlerCalls::executeDeposit)
                    }
                    executeDeposit
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IDepositHandler`](self) contract instance.

See the [wrapper's documentation](`IDepositHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IDepositHandlerInstance<T, P, N> {
        IDepositHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IDepositHandlerInstance<T, P, N>>,
    > {
        IDepositHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IDepositHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IDepositHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IDepositHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IDepositHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IDepositHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IDepositHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IDepositHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IDepositHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IDepositHandlerInstance<T, P, N> {
            IDepositHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
