...
interface ISwapHandler {
    function executeSwap(address account, SwapUtils.SwapParams memory params) external;
    function executeSwapInPosition(address account, SwapUtils.SwapInPositionParams memory params) external;
}
```
...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ISwapHandlerCalls {
        const NAME: &'static str = "ISwapHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ISwapHandlerCalls>] = &[
                {
                    fn executeSwapInPosition(
                        ...
                        <executeSwapInPositionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISwapHandlerCalls::executeSwapInPosition)
                    }
                ...
                },
                {
                    fn executeSwap(
                        ...
                        <executeSwapCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISwapHandlerCalls::executeSwap)
                    }
                    executeSwap
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ISwapHandler`](self) contract instance.

See the [wrapper's documentation](`ISwapHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ISwapHandlerInstance<T, P, N> {
        ISwapHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISwapHandlerInstance<T, P, N>>,
    > {
        ISwapHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ISwapHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ISwapHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ISwapHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ISwapHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ISwapHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ISwapHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ISwapHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ISwapHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISwapHandlerInstance<T, P, N> {
            ISwapHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
    ...
    > ISwapHandlerInstance<T, P, N> {
        ...
        pub fn executeSwap(
            ...
            self.call_builder(&executeSwapCall { account, params })
        }
