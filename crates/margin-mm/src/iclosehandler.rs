...
interface ICloseHandler {
    function executeClose(address account, CloseUtils.CloseParams memory params) external;
}
```
...
```*/
    ...
    ///Container for all the [`ICloseHandler`](self) function calls.
    pub enum ICloseHandlerCalls {
        executeClose(executeCloseCall),
    }
    #[automatically_derived]
    impl ICloseHandlerCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[207u8, 20u8, 84u8, 200u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ICloseHandlerCalls {
        const NAME: &'static str = "ICloseHandlerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ICloseHandlerCalls>] = &[
                {
                    fn executeClose(
                        data: &[u8],
                        validate: bool,
                        ...
                        <executeCloseCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICloseHandlerCalls::executeClose)
                    }
                    executeClose
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ICloseHandler`](self) contract instance.

See the [wrapper's documentation](`ICloseHandlerInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> ICloseHandlerInstance<T, P, N> {
        ICloseHandlerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ICloseHandlerInstance<T, P, N>>,
    > {
        ICloseHandlerInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ICloseHandlerInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ICloseHandler`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ICloseHandler`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ICloseHandlerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ICloseHandlerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ICloseHandlerInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ICloseHandlerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ICloseHandlerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ICloseHandlerInstance<T, P, N> {
            ICloseHandlerInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
