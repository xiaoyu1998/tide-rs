...
pub async fn buy(
   ...
   let paramsSwap: SwapUtils.SwapParams = {
        token0: base_address,
        token1: meme_address,
    ...
    let multicallArgs = [
        exchangeRouter.interface.encodeFunctionData("sendTokens", [base_address, pools[0].bank, amount0_in]),
